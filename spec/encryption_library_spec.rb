...
RSpec.describe EncryptionLibrary do
  ...
  # it "can add a new line if the output is greater than 80 characters" do
  #   encryption_library = EncryptionLibrary.new
  #   expect(encryption_library.word_translation("hello hello hello hello hello hello hello")).to eq("")
  # end
end
